...
class RDisplayCell extends BaseControl
{
    constructor() {
        super('div ', '</div>');
        this.styleAtts.push(new CssDisplayType("table-cell"));
    }
    StartText() {
        return super.BaseStartText();
    }
...
class RDisplayRow extends BaseControl
{
    constructor() {
        super('div ', '</div>');
        this.styleAtts.push(new CssDisplayType("table-row"));
    }
    StartText() {
        return super.BaseStartText();
    }
...
class RDisplayTable extends BaseControl
{
    ...
    {
        super('div ', '</div>');
        this.styleAtts.push(new HeightPercent("100"));
        this.styleAtts.push(new WidthPercent("100"));
        this.styleAtts.push(new CssDisplayType("table"));
    }
    StartText() {
        return super.BaseStartText();
    }
...
class RTextBox extends BaseControl
{
    ...
    StartText() {
        ...
        if (typeof this.contentAtt !== "undefined") {
            //alert('setting textbox value' + this.ContentAttribute);
            htm += " value=\"" + this.contentAtt + "\"";
        }
        htm += " >";
        //alert(htm);
        return htm;
