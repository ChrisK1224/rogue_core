...
{
    public class EmojiValue : ISimpleValueReference
    {
        public long valueID { get; private set; }
        public string value { get; private set; }
        public int complexWordCount { get { return 0; } }
        public byte dataTypeID { get { return BinaryDataPair.dtEmoji; } }
        public EmojiValue(string line)
        {
            var split = line.Split(RogueTypeTable.valueSeparatorChar);
            this.valueID = new UnKnownID(split[0]);
            this.value = split[1];
        }
        public EmojiValue(RowID rowID, string value)
        {
