...
{
    class StandardColumn : IDableLocation<ColumnRowID>, ILocationColumn
    {
        public string columnName { get { return base.name; } }     
        public string upperColumnName { get; private set; }
        public string colTableRefName { get; protected set; } = "";
        public ColumnRowID columnRowID { get { return base.ID; } }
        public bool isConstant { get { return false; } }
        //public override List<string> paramOptions { get { return new List<string>() { colTableRefName, columnName }; } }
        string temp = "";
        public StandardColumn(string colTxt) : base(colTxt) 
        {
            temp = colTxt;
        ...
        protected StandardColumn(ColumnRowID columnRowID) : base(columnRowID) { }
        protected StandardColumn(ColumnRowID columnRowID, string colTableRefName) : base(columnRowID) { this.colTableRefName = colTableRefName.ToUpper(); name = ID.ToColumnName().ToUpper(); this.upperColumnName = columnName; }
        protected StandardColumn(ColumnRowID columnRowID, string columnName, string colTableRefName) : base(columnRowID) { this.colTableRefName = colTableRefName.ToUpper(); name = columnName; upperName = name.ToUpper(); }
