...
namespace rogueCore.hqlSyntaxV3.segments.snippet
{
    ...
    //    public SnippetFormatter(string fullHQL, SelectHQLStatement queryStatement)
    //    {
    //        hqlBuilder = new StringBuilder(fullHQL);
    //        var snippets = new MultiSymbolSegment<PlainList<Snippet>, Snippet>(SymbolOrder.randombetweensymbols, fullHQL, new string[2] { snipStart, snipEnd }, (x,y) => new Snippet(x)).segmentItems;
